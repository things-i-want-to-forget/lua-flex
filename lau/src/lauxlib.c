...
*/
#define l_inspectstat(stat,what) if (WIFEXITED(stat)) { stat = WEXITSTATUS(stat); } \
...
** to open a module, registers the result in 'package.loaded' table and, ** if 'glb' is true, also registers the result in the global table.
